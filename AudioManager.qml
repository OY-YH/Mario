...
Item {
  ...
  SoundEffect {
    id: playerJump
    source: "../../assets/audio/sounds/jump.wav"
  }
  ...
  SoundEffect {
    id: collectCoin
    source: "../../assets/audio/sounds/coin.wav"
  }

  SoundEffect {
    id: collectMushroom
    source: "../../assets/audio/sounds/mushroom.wav"
  }

  SoundEffect {
    id: finish
    source: "../../assets/audio/sounds/finish.wav"
  }

  SoundEffect {
    id: opponentWalkerDie
    source: "../../assets/audio/sounds/walkerDie.wav"
  }
